...
{
    std::string testLine =
        "/home/christo/BCN/rdk5/build-hx4x.lib32-hp48a-rdk/tmp/work/armv7at2hf-neon-rdkmllib32-linux-gnueabi/lib32-aamp/rdkv-2023q2-dunfell-r0/"
        "recipe-sysroot-native/usr/bin/arm-rdkmllib32-linux-gnueabi/arm-rdkmllib32-linux-gnueabi-g++  -Daamp_EXPORTS -Istaging "
        "-I/home/christo/BCN/rdk5/build-hx4x.lib32-hp48a-rdk/tmp/work/armv7at2hf-neon-rdkmllib32-linux-gnueabi/lib32-aamp/rdkv-2023q2-dunfell-r0/git "
        "-I/home/christo/BCN/rdk5/build-hx4x.lib32-hp48a-rdk/tmp/work/armv7at2hf-neon-rdkmllib32-linux-gnueabi/lib32-aamp/rdkv-2023q2-dunfell-r0/git/"
        "PRIVATE "
        "-I/home/christo/BCN/rdk5/build-hx4x.lib32-hp48a-rdk/tmp/work/armv7at2hf-neon-rdkmllib32-linux-gnueabi/lib32-aamp/rdkv-2023q2-dunfell-r0/"
        ...
        "--sysroot=/home/christo/BCN/rdk5/build-hx4x.lib32-hp48a-rdk/tmp/work/armv7at2hf-neon-rdkmllib32-linux-gnueabi/lib32-aamp/"
        "rdkv-2023q2-dunfell-r0/lib32-recipe-sysroot  -Os -pipe -g -feliminate-unused-debug-types "
        "-fmacro-prefix-map=/home/christo/BCN/rdk5/build-hx4x.lib32-hp48a-rdk/tmp/work/armv7at2hf-neon-rdkmllib32-linux-gnueabi/lib32-aamp/"
        "rdkv-2023q2-dunfell-r0=/usr/src/debug/lib32-aamp/rdkv-2023q2-dunfell-r0                      "
        "-fdebug-prefix-map=/home/christo/BCN/rdk5/build-hx4x.lib32-hp48a-rdk/tmp/work/armv7at2hf-neon-rdkmllib32-linux-gnueabi/lib32-aamp/"
        "rdkv-2023q2-dunfell-r0=/usr/src/debug/lib32-aamp/rdkv-2023q2-dunfell-r0                      "
        "-fdebug-prefix-map=/home/christo/BCN/rdk5/build-hx4x.lib32-hp48a-rdk/tmp/work/armv7at2hf-neon-rdkmllib32-linux-gnueabi/lib32-aamp/"
        "rdkv-2023q2-dunfell-r0/lib32-recipe-sysroot=                      "
        "-fdebug-prefix-map=/home/christo/BCN/rdk5/build-hx4x.lib32-hp48a-rdk/tmp/work/armv7at2hf-neon-rdkmllib32-linux-gnueabi/lib32-aamp/"
        "rdkv-2023q2-dunfell-r0/recipe-sysroot-native=   -fvisibility-inlines-hidden  -march=armv7-a -mthumb -mfpu=neon -mfloat-abi=hard   "
        "--sysroot=/home/christo/BCN/rdk5/build-hx4x.lib32-hp48a-rdk/tmp/work/armv7at2hf-neon-rdkmllib32-linux-gnueabi/lib32-aamp/"
        "rdkv-2023q2-dunfell-r0/lib32-recipe-sysroot  -DAAMP_BUILD_INFO=rdkv-2023q2-dunfell -DNO_NATIVE_AV -DPLAYBINTEST_WESTEROSSINK "
        "-I/home/christo/BCN/rdk5/build-hx4x.lib32-hp48a-rdk/tmp/work/armv7at2hf-neon-rdkmllib32-linux-gnueabi/lib32-aamp/rdkv-2023q2-dunfell-r0/"
        "lib32-recipe-sysroot/usr/include/rdk/ds "
        "-I/home/christo/BCN/rdk5/build-hx4x.lib32-hp48a-rdk/tmp/work/armv7at2hf-neon-rdkmllib32-linux-gnueabi/lib32-aamp/rdkv-2023q2-dunfell-r0/"
        "lib32-recipe-sysroot/usr/include/rdk/ds-hal "
        "-I/home/christo/BCN/rdk5/build-hx4x.lib32-hp48a-rdk/tmp/work/armv7at2hf-neon-rdkmllib32-linux-gnueabi/lib32-aamp/rdkv-2023q2-dunfell-r0/"
        "lib32-recipe-sysroot/usr/include/rdk/iarmbus "
        "-I/home/christo/BCN/rdk5/build-hx4x.lib32-hp48a-rdk/tmp/work/armv7at2hf-neon-rdkmllib32-linux-gnueabi/lib32-aamp/rdkv-2023q2-dunfell-r0/"
        "lib32-recipe-sysroot/usr/include/rdk/ds-rpc "
        "-I/home/christo/BCN/rdk5/build-hx4x.lib32-hp48a-rdk/tmp/work/armv7at2hf-neon-rdkmllib32-linux-gnueabi/lib32-aamp/rdkv-2023q2-dunfell-r0/"
        "lib32-recipe-sysroot/usr/include/rdk/iarmmgrs/ir   -I=/usr/include/rdk/iarmbus/ -I=/usr/include/rdk/iarmmgrs-hal -Wno-multichar -std=c++11 "
        "-Wno-non-virtual-dtor -Wno-psabi -g -fPIC    -DAAMP_VANILLA_AES_SUPPORT -DUSE_MAC_FOR_RANDOM_GEN -DAAMP_BUILD_INFO='GNU/Linux-x86_64' "
        "-DNO_NATIVE_AV=1 -DAMLOGIC -DCONTENT_4K_SUPPORTED -DSUPPORT_JS_EVENTS -DIARM_MGR=1 -DUSE_THUNDER_OCDM_API_0_2 -DAAMP_MPD_DRM=1 "
        "-DUSE_OPENCDM -DAAMP_HLS_DRM=1 -DDRM_BUILD_PROFILE=DRM_BUILD_PROFILE_OEM -DTARGET_LITTLE_ENDIAN=1 "
        "-DTARGET_SUPPORTS_UNALIGNED_DWORD_POINTERS=0 -DUSE_CLEARKEY -DUSE_OPENCDM_ADAPTER -DUSE_OPENCDM -DAAMP_CC_ENABLED -DAAMP_RFC_ENABLED "
        "-DAAMP_SUBTEC_CC_ENABLED  -DUSE_SYSTEMD_JOURNAL_PRINT=1 -DSD_JOURNAL_SUPPRESS_LOCATION=1 -DUSE_ICX_TELEMETRY -DAAMP_WPEWEBKIT_JSBINDINGS "
        "-DUSE_CPP_THUNDER_PLUGIN_ACCESS -MD -MT CMakeFiles/aamp.dir/priv_aamp.cpp.o -MF CMakeFiles/aamp.dir/priv_aamp.cpp.o.d -o "
        "CMakeFiles/aamp.dir/priv_aamp.cpp.o -c "
        "/home/christo/BCN/rdk5/build-hx4x.lib32-hp48a-rdk/tmp/work/armv7at2hf-neon-rdkmllib32-linux-gnueabi/lib32-aamp/rdkv-2023q2-dunfell-r0/git/"
        "priv_aamp.cpp";
    EXPECT_EQ(GetCompilerOutputLineInfo(testLine).type, CompilerOutputLineType::normal);
}
